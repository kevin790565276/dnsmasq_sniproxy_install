...
install_dnsmasq(){
    ...
    download /etc/dnsmasq.d/custom_netflix.conf https://raw.githubusercontent.com/kevin790565276/dnsmasq_sniproxy_install/master/dnsmasq.conf
    download /tmp/proxy-domains.txt https://raw.githubusercontent.com/kevin790565276/dnsmasq_sniproxy_install/master/proxy-domains.txt
...
install_sniproxy(){
    ...
    download /etc/sniproxy.conf https://raw.githubusercontent.com/kevin790565276/dnsmasq_sniproxy_install/master/sniproxy.conf
    download /tmp/sniproxy-domains.txt https://raw.githubusercontent.com/kevin790565276/dnsmasq_sniproxy_install/master/proxy-domains.txt
